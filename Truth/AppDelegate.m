...
/*    
    FirstPage *firstPage = [[FirstPage alloc] init];   
    CombineViews *combineViews = [[CombineViews alloc] init];
    self.navigationController = [[[UINavigationController alloc] initWithRootViewController:combineViews] autorelease];
...
//    self.window.rootViewController = personInfo;
    FirstPage *firstPage = [[FirstPage alloc] init];    
    UINavigationController *navigationController = [[[UINavigationController alloc] initWithRootViewController:firstPage] autorelease];
...
//    UITabBarItem *item = [[UITabBarItem alloc] initWithTitle:@"asdfsadf" image:[UIImage imageNamed:@"top.png"] tag:0];
    NSArray *viewControl = [NSArray arrayWithObjects:navigationController, personInfo, nil];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Truth" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Truth.sqlite"];
